...
export default {
  ...
  safelist: [
    /^(bg|text|border|p|m|h|w|min-w|max-w|min-h|max-h|flex|grid|items|justify|space|z|opacity|shadow|rounded|font|leading|tracking|hover|focus|active|group|dark|transform|transition)/,
  ],
